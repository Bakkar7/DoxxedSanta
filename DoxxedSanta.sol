...
/**
 ...
 Christmas is approaching, and it is time to celebrate! Doxxed Santa is here to brighten your holidays, we are a community driven token. 
 With the Christmas hype, Santa is here to drive you to the moon!
 
 Telegram: t.me/Doxxedsanta
 Website: www.Doxxedsanta.com
...
contract DoxxedSanta is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doxxed Santa";
    string private constant _symbol = "DxSanta";
